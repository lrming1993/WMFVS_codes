...
with open("result/temp_MFVS_weight_ignore.txt") as f2:
...
with open("result/compressed_graph_weight_ignore.txt") as f1:
...
model_1.addConstr(quicksum(variables_x) >= MFVS_num - len(temp_list))
model_1.addConstr(quicksum(variables_x) <= MFVS_num - len(temp_list))
...
with open("result/ILP_result_with_weight_ignore.txt", "w") as f2:
